...
public class CoffeeMenuMain {
    ...
    static void makeMenu() {
        map.put("아메리카노", new MenuInfo("아메리카노",2000,"coffee","normalcoffee"));
        map.put("espresso", new MenuInfo("espresso",2200,"coffee","deepcoffee"));
        map.put("latte", new MenuInfo("latte",4000 ,"coffee","milk"));
